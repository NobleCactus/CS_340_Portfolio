...
def build_query_searchTitle(query_vals):
	...
	query = "SELECT t.titleID, t.titleName, DATE_FORMAT(t.titleRelease, '%Y-%m-%d'), t.titleGenre, f.franchiseName, d.developerName, t.titleESRB FROM `VideoGameTitles` AS t "
